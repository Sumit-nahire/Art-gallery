...
$ret=pg_query($con,"select adminname from tbladmin where id='$adid'");
$row=pg_fetch_array($ret,null,PGSQL_ASSOC);
$name=$row['adminname'];
      ...
      <div class="top-nav notification-row">
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="alert_notificatoin_bar" class="dropdown">
            <?php                                        
$ret1=pg_query($con,"select *from  tblenquiry where (status='' or status is null)");
$num1=pg_num_rows($ret1);?>
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                ...
                <?php   
if($num1>0)    {                                 
while ($row=pg_fetch_array($ret1,null,PGSQL_ASSOC)) { ?>
       <li>
