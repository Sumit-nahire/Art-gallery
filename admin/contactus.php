...
$timing=$_POST['timing'];
  $query=pg_query($con,"update tblpage set pagetitle='$pagetitle', pagedescription='$pagedes',email='$email',mobilenumber='$phonenum', timing='$timing' where  pagetype='contactus'");
