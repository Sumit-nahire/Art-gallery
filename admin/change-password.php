...
$query=pg_query($con,"select id from tbladmin where id='$adminid' and password='$cpassword'");
$row=pg_fetch_array($query,null,PGSQL_ASSOC);
if($row>0){
$ret=pg_query($con,"update tbladmin set password='$newpassword' where id='$adminid'");
