        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
              <?php $query = pg_query($con, "Select * from tblartist");
              $artcount = pg_num_rows($query);
              ?>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box green-bg">
            <?php 
        // Fetch total user count from tblusers
        $query1 = pg_query($con, "SELECT COUNT(*) AS total_users FROM tblusers");
        $row = pg_fetch_assoc($query1);
        $usercount = $row['total_users'];
        ?>
              <i class="fa fa-user"></i>
              <div class="count"><?php echo $usercount; ?></div>
              <div class="title"> <a class="dropdown-item" href="total-users.php">Total users</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              <?php $query1 = pg_query($con, "Select * from tblenquiry where status='Answer'");
              $aenqcount = pg_num_rows($query1);
              ?>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              ...
              $artcount = pg_num_rows($query2);
              ?>
              <i class="fa fa-file"></i>
              <div class="count"><?php echo $artcount; ?></div>
              <div class="title"> <a class="dropdown-item" href="manage-orders.php">Total orders</a></div>
            </div>
            <!--/.info-box-->
          </div>
          <!--/.col-->
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box brown-bg">
              <?php $query1 = pg_query($con, "Select * from tblartmedium");
              $amcount = pg_num_rows($query1);
              ?>
              <i class="fa fa-file"></i>
          ...
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            <div class="info-box dark-bg">
              <?php $query2 = pg_query($con, "Select * from tblartproduct");
              $apcount = pg_num_rows($query2);
              ?>
              <i class="fa fa-file"></i>
