...
if(isset($_POST['submit'])) {
    ...
    $query = pg_prepare($con, "check_user", "SELECT id FROM tbladmin WHERE email = $1 AND mobilenumber = $2");
...
<html lang="en">
<head>
    <title>Admin Forgot Password | Art Gallery Management System</title>
