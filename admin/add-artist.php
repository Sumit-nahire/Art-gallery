...
// Insert data into tblartist
$query = pg_query($con, "INSERT INTO tblartist (name, mobilenumber, email, education, award, profilepic) 
                        VALUES ('$name', '$mobnum', '$email', '$edudetails', '$awarddetails', '$proimg')");
