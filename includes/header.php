            ...
            ?>
                <ul>
                    <li>
                        ...
                        <p><?php echo htmlspecialchars($row['mobilenumber']); ?></p>
                    </li>
                    <li>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        while ($row = pg_fetch_array($ret, null, PGSQL_ASSOC)) {
                        ?>
                            <a class="dropdown-item" href="product.php?cid=<?php echo $row['id']; ?>&artname=<?php echo urlencode($row['arttype']); ?>">
                                <?php echo htmlspecialchars($row['arttype']); ?>
                            </a>
                        <?php }?>
                    </div>
                </li>
